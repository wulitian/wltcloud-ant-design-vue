<template>
  <div>
    ...
    <div class="a-header">
      <a-col class="gutter-row" :span="4">
        <div class="gutter-box">
          <label>结构形式:</label>
          <a-input placeholder="结构形式" v-model="headerForm.jgxs"/>
        </div>
      </a-col>
      <a-col class="gutter-row" :span="4">
        <div class="gutter-box">
    ...
    <a-modal v-model="modalState" :title="modalTitle" :footer="null">
      ...
      >
        <a-form-model-item label="结构形式" prop="jgxs">
          <a-input v-model="form.jgxs" placeholder="结构形式"/>
        </a-form-model-item>
  ...
  const formModeMixins = {
    data () {
      return {
        ...
        rules: {
          jgxs: [{ required: true, message: '请输入结构形式', trigger: 'blur' }],
