<template>
  <div>
    ...
    <div class="a-header">
      <a-col class="gutter-row" :span="4">
        <div class="gutter-box">
          <label>承揽方式:</label>
          <a-input placeholder="承揽方式" v-model="headerForm.clfs"/>
        </div>
      </a-col>
      <a-col class="gutter-row" :span="4">
        <div class="gutter-box">
    ...
    <a-modal v-model="modalState" :title="modalTitle" :footer="null">
      ...
      >
        <a-form-model-item label="承揽方式" prop="clfs">
          <a-input v-model="form.clfs" placeholder="承揽方式"/>
        </a-form-model-item>
  ...
  const formModeMixins = {
    data () {
      return {
        ...
        rules: {
          clfs: [{ required: true, message: '请输入承揽方式', trigger: 'blur' }],
