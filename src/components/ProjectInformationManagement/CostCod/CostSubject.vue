<template>
  <div>
    ...
    <div class="a-header">
      <a-col class="gutter-row" :span="4">
        <div class="gutter-box">
          <label>成本科目:</label>
          <a-input placeholder="成本科目" v-model="headerForm.cbkm"/>
        </div>
      </a-col>
      <a-col class="gutter-row" :span="4">
        <div class="gutter-box">
    ...
    <a-modal v-model="modalState" :title="modalTitle" :footer="null">
      ...
      >
        <a-form-model-item label="成本科目" prop="cbkm">
          <a-input v-model="form.cbkm" placeholder="部门名称"/>
        </a-form-model-item>
        <a-form-model-item label="大类名称" prop="dlmc">
          <a-input v-model="form.dlmc" placeholder="部门名称"/>
        </a-form-model-item>
        <a-form-model-item label="目标描述" prop="mbms">
          <a-input v-model="form.mbms" placeholder="部门名称"/>
        </a-form-model-item>
...
<script>
  ...
  const columns = [
    { title: '成本科目',dataIndex: 'cbkm',key: 'cbkm' },
    { title: '大类名称',dataIndex: 'dlmc',key: 'dlmc' },
  ...
  const formModeMixins = {
    data () {
      return {
        ...
        rules: {
          cbkm: [{ required: true, message: '请输入成本名称', trigger: 'blur' }],
          dlmc: [{ required: true, message: '请输入大类名称', trigger: 'blur' }],
          mbms: [{ required: true, message: '请输入目标描述', trigger: 'blur' }],
        }
      }
    },
    created () {
